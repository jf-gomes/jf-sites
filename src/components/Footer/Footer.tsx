        ...
        <footer>
            <div className='flex justify-around items-center flex-wrap gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-xs text-justify'>JF Sites é uma empresa de desenvolvimento de sites profissionais e elegantes. Quer um website 100% funcional para o seu negócio? Entre em contato com o nosso time!</p>
                </div>
                <ul className='flex gap-6 text-xs p-6'>
